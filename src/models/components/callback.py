...
class MyPrintingCallback(pl.callbacks.Callback):
    ...
    def on_train_end(self, trainer: pl.Trainer, model: pl.LightningModule) -> None:
        ...
        visualize.plot_gridspectrum(eval=True,latent_op=None,show=False,save_path=None)
        visualize.plot_gridwaveform(eval=True,latent_op=None,show=False,save_path=None)
